...
/* const callsToAction = [
  { name: "Watch Demo", href: "#", icon: Fa.FaPlay },
  { name: "Contact Sales", href: "#", icon: Fa.FaPhone },
]; */
const resources = [
  {
    name: "Help Center",
...
const Menu: React.FC = () => {
  const Dropdown = useCallback(({ title, items }) => {
    return (
            ...
            <div className="flex justify-between items-center py-2 md:justify-start md:space-x-10">
              <div className="flex justify-start lg:w-0 lg:flex-1">
                <a href="#">
                  ...
                  <img className="h-8 w-auto" src={menu.logo} alt="" />
                </a>
              </div>
              <div className="-mr-2 -my-2 md:hidden">
                <Popover.Button className="rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                  ...
                  <Fa.FaBars className="h-6 w-6" aria-hidden="true" />
                </Popover.Button>
              </div>
              <Popover.Group as="nav" className="hidden md:flex space-x-10">
                {menu.mainItems.map((itemMenu) => {
                  if (Array.isArray(itemMenu.items)) {
                    ...
                    if (typeof itemMenu.href === "string") {
                      if (isValidURL(itemMenu.href)) {
                        return (
                          <a
                            href={itemMenu.href}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="-mr-2">
                      <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                        ...
                        <Fa.FaTimes className="h-6 w-6" aria-hidden="true" />
                      </Popover.Button>
                    </div>
                  </div>
                  <div className="mt-6">
